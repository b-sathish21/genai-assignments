...
export function TestcasePanel({
  ...
  const usesInception = generationSource.includes("inception");
  const engineLabel = usesInception
    ? `Inception Labs${generationModel ? ` · ${generationModel}` : ""}`
    ...
    <section className="card testcase-card">
      <div className="section-heading split">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <StatusPill tone={usesInception ? "success" : "warning"} title={`Generation source: ${generationSource}`}>
            {engineLabel}
          </StatusPill>
