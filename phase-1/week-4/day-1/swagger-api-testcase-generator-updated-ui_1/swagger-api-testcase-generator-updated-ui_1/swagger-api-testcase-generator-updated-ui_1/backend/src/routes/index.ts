...
import { correctSwagger, uploadSwagger, validateSwagger } from "../controllers/swagger.controller.js";
...
import { llmEnabled } from "../config/environment.js";

export const apiRouter = Router();

apiRouter.get("/health", (_req, res) => {
  res.json({ success: true, data: { status: "ok", llmConfigured: llmEnabled, provider: "inception" } });
});
